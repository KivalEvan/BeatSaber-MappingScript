// @ts-check
/**
 * @typedef {import('./types/easings').Easings} Easings
 * @typedef {import('./types/easings').EasingFunction} EasingFunction
 * @typedef {import('./types/easings').Transition} Transition
 * @typedef {import('./types/easings').Curve} Curve
 */
...
/** @type {Record<Easings, EasingFunction>} */
const func = {
   easeLinear: (x) => x,
   easeStep: (x) => x,
...
// less scary
/** @type {{[key in import('./types/utils').LooseAutocomplete<`${Transition}${Curve}` | 'Linear' | 'Step'>]: EasingFunction}} */
const mapped = {
   Linear: func.easeLinear,
   Step: func.easeStep,
   InQuad: func.easeInQuad,
   OutQuad: func.easeOutQuad,
   InOutQuad: func.easeInOutQuad,
   InCubic: func.easeInCubic,
   OutCubic: func.easeOutCubic,
   InOutCubic: func.easeInOutCubic,
   InQuart: func.easeInQuart,
   OutQuart: func.easeOutQuart,
   InOutQuart: func.easeInOutQuart,
   InQuint: func.easeInQuint,
   OutQuint: func.easeOutQuint,
   InOutQuint: func.easeInOutQuint,
   InSine: func.easeInSine,
   OutSine: func.easeOutSine,
   InOutSine: func.easeInOutSine,
   InCirc: func.easeInCirc,
   OutCirc: func.easeOutCirc,
   InOutCirc: func.easeInOutCirc,
   InExpo: func.easeInExpo,
   OutExpo: func.easeOutExpo,
   InOutExpo: func.easeInOutExpo,
   InElastic: func.easeInElastic,
   OutElastic: func.easeOutElastic,
   InOutElastic: func.easeInOutElastic,
   InBack: func.easeInBack,
   OutBack: func.easeOutBack,
   InOutBack: func.easeInOutBack,
   InBounce: func.easeInBounce,
   OutBounce: func.easeOutBounce,
   InOutBounce: func.easeInOutBounce,
};

const list = /** @type {(`${Transition}${Curve}` | 'Linear' | 'Step')[]} */ (Object.keys(mapped));
