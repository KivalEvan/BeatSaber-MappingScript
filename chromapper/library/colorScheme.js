// @ts-check
/**
 * @typedef {import('./types/beatmap/shared/colorScheme').ColorSchemeName} ColorSchemeName
 * @typedef {import('./types/beatmap/v2/custom/colorScheme').IColorScheme} IColorScheme
 * @typedef {import('./types/beatmap/shared/environment').EnvironmentAllName} EnvironmentAllName
 */

/**
 * Record of Environment Color to Color Scheme.
 * @type {{ readonly [key in EnvironmentAllName]: ColorSchemeName }}
 * @constant
 * @default
 */
const EnvironmentSchemeName = {
 ...
 * @type {{ readonly [key in ColorSchemeName]: Readonly<IColorScheme> }}
 * @constant
 * @default
 */
const ColorScheme = {
...
module.exports = { EnvironmentSchemeName, ColorScheme };
