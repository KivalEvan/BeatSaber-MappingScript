...
import { globals, range, save, v4 } from '../../depsLocal.ts';
import wipPath from '../../utility/wipPath.ts';
import { lightitup, LightPositionMapping } from './lightitup.ts';

globals.directory = wipPath('Bad Apple');
const gifFile = Deno.readFile('./map/BadApple/badapplelattice.gif');

const lightshow = v4.Lightshow.create().setFilename('Lattice.lightshow.dat');
