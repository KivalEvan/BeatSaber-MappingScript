...
export function eventBoxSwapColor<
   T extends Partial<types.wrapper.IWrapLightColorBaseAttribute>,
>(
   obj: T[],
): T[] {
...
export function objectTimeScale<
   T extends Partial<types.wrapper.IWrapBaseObjectAttribute>,
>(
   obj: T[],
   scale: number,
): T[] {
...
export function objectTimeShift<
   T extends Partial<types.wrapper.IWrapBaseObjectAttribute>,
>(
   obj: T[],
   shift: number,
