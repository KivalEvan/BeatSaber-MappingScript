...
export default (d: v3.Difficulty) => {
    ...
    for (let id = 12; id < 14; id++) {
        ...
        const events = [
            { color: EventBoxColor.WHITE, brightness: Brightness.EXTRA, frequency: 12 },
    ...
    for (let time = 68; time < 70; time++) {
        for (let id = 14; id < 16; id++) {
            ...
            const events = [
                { color: EventBoxColor.WHITE, brightness: Brightness.DOUBLE, frequency: 12 },
                { time: 0.25, transition: TransitionType.EXTEND },
                { time: 0.375, brightness: Brightness.ZERO },
                {
                    color: EventBoxColor.RED,
                    brightness: Brightness.FULL,
                    frequency: 8,
            ...
            d.addLightRotationEventBoxGroups(
                {
                    ...
                    boxes: [
                        ...
                        },
                        {
                            ...
                            rotationDistribution: -30,
                            affectFirst: 1,
                            events: [{ easing: EaseType.NONE, rotation: 270 - (time - 68) * 30 }],
                        },
                        {
                            filter: fltrR,
                            axis: Axis.Y,
                            rotationDistribution: -30,
                            affectFirst: 1,
                            events: [{ easing: EaseType.NONE, rotation: 90 - (time - 68) * 30 }],
                        },
                    ],
                },
                {
                    ...
                    boxes: [
                        ...
                        },
                        {
                            ...
                            rotationDistribution: -45,
                            affectFirst: 1,
                            events: [{ easing: EaseType.OUT_QUAD, rotation: 270 - (time - 68) * 30 }],
                        },
                        {
                            filter: fltrR,
                            axis: Axis.Y,
                            rotationDistribution: -45,
                            affectFirst: 1,
                            events: [{ easing: EaseType.OUT_QUAD, rotation: 90 - (time - 68) * 30 }],
                        },
                    ],
                }
            );
    ...
    for (let id = 0; id < 12; id++) {
        d.addLightRotationEventBoxGroups({
            ...
            boxes: [
                ...
                {
                    filter: { type: IndexFilterType.STEP_AND_OFFSET, p1: 4, reverse: 1 },
                    events: [
                        {
                            easing: EaseType.NONE,
                            rotation:
                ...
                {
                    filter: { type: IndexFilterType.STEP_AND_OFFSET, p0: 1, p1: 4, reverse: 1 },
                    events: [
                        {
                            easing: EaseType.NONE,
                            rotation:
                ...
                {
                    filter: { type: IndexFilterType.STEP_AND_OFFSET, p0: 2, p1: 4, reverse: 1 },
                    events: [
                        {
                            easing: EaseType.NONE,
                            rotation:
                ...
                {
                    filter: { type: IndexFilterType.STEP_AND_OFFSET, p0: 3, p1: 4, reverse: 1 },
                    events: [
                        {
                            easing: EaseType.NONE,
                            rotation:
