...
import convertSlider from 'https://deno.land/x/bsmap@1.0.0/example/jankySliderConvert.ts';
...
bsmap.save.difficultyListSync(difficultyList, {
   path:
      'D:/SteamLibrary/steamapps/common/Beat Saber/Beat Saber_Data/CustomLevels/Deconstruction Star/',
});
