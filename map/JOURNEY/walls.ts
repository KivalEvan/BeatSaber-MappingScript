import { Beatmap, colorFrom, lerp, normalize, Obstacle, types, v3 } from '@bsmap';

export function walls(data: Beatmap) {
   let tempWall = Obstacle.create(
      ...
      ].map((x) => v3.obstacle.deserialize(x as types.v3.IObstacle)),
   );
